...
# Interpretability-specific directories
INTERPRETABILITY_RESULTS_DIR = ANALYSIS_RESULTS_DIR / "interpretability"
INTERPRETABILITY_ACTIVATIONS_DIR = INTERPRETABILITY_RESULTS_DIR / "activations"
INTERPRETABILITY_LOGITS_DIR = INTERPRETABILITY_RESULTS_DIR / "logits"
INTERPRETABILITY_FIGURES_DIR = INTERPRETABILITY_RESULTS_DIR / "figures"
...
for dir_path in [PROCESSED_DATA_DIR, FIGURES_DIR, 
                 INTERPRETABILITY_RESULTS_DIR, INTERPRETABILITY_ACTIVATIONS_DIR, 
                 INTERPRETABILITY_LOGITS_DIR, INTERPRETABILITY_FIGURES_DIR]:
    dir_path.mkdir(parents=True, exist_ok=True)

# Experiment parameters
MAZE_SIZES = [(5, 5), (7, 7)]  # Note: 9x9 mazes exist but were not tested
MAZE_SHAPES = ["square", "cross", "spiral", "triangle", "C", "Z"]
ENCODING_TYPES = ["matrix", "coord_list", "vision"]
TASKS = ["solve", "recognize", "generate"]

# Model configurations with actual checkpoints used
MODEL_CHECKPOINTS = {
    "claude-3.5-sonnet": "claude-3-5-sonnet-20241022",
    "claude-opus-4": "claude-opus-4-20250514",
    "gpt-4o": "gpt-4o (api_version=2023-12-01-preview)",
    "llama-3.1-405b": "Llama-3.1-405B-Instruct",
    "llama-3.1-70b": "Llama-3.1-70B-Instruct",
    # Qwen models for interpretability experiments
...
# Mapping from internal model names to providers
LLM_MODELS = {
    "gpt-4o": "openai",
    "claude-3.5-sonnet": "anthropic",
    "claude-4": "anthropic",  # Actually Claude Opus 4
    "claude-4-opus": "anthropic",
    "gemini-1.5-pro": "google",
    "llama-3.1": "llama"
}

# Model family groupings for analysis
MODEL_FAMILY = {
    "claude-3.5-sonnet": "Claude-3.5-Sonnet",
    "claude-4": "Claude-Opus-4",  # Clearer naming
...
VISION_MODELS = {
    ...
    "opus": "claude-4-opus"  # claude-opus-4-20250514
}

# Directory name mappings (for backwards compatibility)
RESULT_DIR_MAPPING = {
    "coord_list_claude_results": "Claude-3.5-Sonnet",
    "coord_list_claude4_results": "Claude-Opus-4",
    "matrix_claude_results": "Claude-3.5-Sonnet",
    "matrix_claude4_results": "Claude-Opus-4",
    "sonnet_vision_results": "Claude-3.5-Sonnet",
    "opus_vision_results": "Claude-Opus-4"
}
...
EDIT_DISTANCES_FILE = DATA_DIR / "edit_distance" / "maze_edit_distances.json"
HUMAN_EDIT_DISTANCES_FILE = DATA_DIR / "edit_distance" / "human_edit_distances.json"
